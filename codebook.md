...
The variable tBodyGyro-mean()-X is the average value by subject and activity of the time domain Body gyroscope acceleration X axis signal mean value.

The variable fBodyBodyAccJerkMag-std()  is the average value by subject and activity of the standard deviation of the frequency domain body acceleration Jerk signal magnitud. 
